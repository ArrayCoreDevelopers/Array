...
const QString BITCOIN_IPC_PREFIX("array:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/array-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/array-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/array-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click array: links
...
//
// OSX-specific way of handling array: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in array: URIs
