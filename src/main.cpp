...
#if defined(NDEBUG)
# error "Array cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Array Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Array also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Array also requires low S in sigs
